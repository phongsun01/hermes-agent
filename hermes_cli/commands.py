...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("cronmenu", "Hiển thị danh sách các tác vụ cron đang chạy", "Tools & Skills",
               ...
               subcommands=("list",)),
    CommandDef("xsmenu", "Hiển thị menu tương tác kết quả xổ số miền Bắc", "Tools & Skills",
               gateway_only=True),
    CommandDef("ccmenu", "Hiển thị menu tương tác quản lý công văn Quảng Ninh", "Tools & Skills",
               gateway_only=True),
    CommandDef("tkbmenu", "Hiển thị menu tương tác thời khóa biểu gia đình", "Tools & Skills",
               gateway_only=True),
    CommandDef("news", "Xem thông tin cập nhật hàng ngày (giá vàng, xăng, tỷ giá, thời tiết...)", "Tools & Skills",
               args_hint="[vang|xang|tygia|thoitiet|trieucuong|amlich|tintuc|today]",
               subcommands=("vang", "xang", "tygia", "thoitiet", "trieucuong", "amlich", "tintuc", "today")),
    CommandDef("newsmenu", "Hiển thị menu tương tác bản tin sáng", "Tools & Skills",
               gateway_only=True),
