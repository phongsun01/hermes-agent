 ...
 */
export function canSendSticker(threadId) {
 ...
 */
export async function searchStickers(api, keyword, limit = 5) {
 ...
 */
export async function sendSticker(api, sticker, threadId, threadType) {
 ...
 */
export async function searchAndSendSticker(api, keyword, threadId, threadType) {
    if (!canSendSticker(threadId))
        return false;
    try {
