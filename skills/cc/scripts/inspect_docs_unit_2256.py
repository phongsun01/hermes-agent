...
def extract_documents(html):
    ...
    for r_html in rows:
        ...
        docs.append({"so_den": so_den, "so_ky_hieu": so_ky_hieu, "trich_yeu": trich_yeu[:60]})
    return docs
...
def main():
    with sync_playwright() as p:
        ...
        # Go to unit select page and select 2256 (Bệnh viện Sản nhi Quảng Ninh)
        print("Selecting unit 2256...")
        ...
        print(f"Found {len(docs)} documents on page 1 of Unit 2256:")
        for d in docs:
