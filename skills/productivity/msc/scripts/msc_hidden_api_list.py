...
def fetch(token: str, kind: str, unit_id: str, n: int, day_from: Optional[datetime], day_to: Optional[datetime], cookie: str = "", exclude_case_khkq: bool = False, entity_field: str = "procuringEntityCode") -> Dict[str, Any]:
...
def main():
    ...
    out = fetch(token, args.kind, args.unit_id, args.n, df, dt, cookie, exclude_case_khkq=args.exclude_case_khkq, entity_field=args.entity_field)
    print(json.dumps({
        "kind": args.kind,
